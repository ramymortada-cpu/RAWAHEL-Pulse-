...
Security: RBAC, production env validation, token hash storage, approval gates, audit logs, and tests are positive controls. Gaps: rate limiting/security headers/CSRF evidence, dependency scanning, monitoring, backup proof, formal privacy/compliance runbooks.

## Required Coverage Checklist

- Threat model: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- OWASP/ASVS/NIST/ISO/SOC2/GDPR mappings: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Auth/input/API/secrets/dependency: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Security roadmap: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
