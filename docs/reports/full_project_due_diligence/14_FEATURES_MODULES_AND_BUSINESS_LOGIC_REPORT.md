...
Feature modules: strategic tracks/goals/entities, KPI definitions and entry, external submissions, approval/revision/rejection, approved-only dashboards, report templates, PDF/PNG export, admin portal, user management, audit logs, production readiness gate. See inventories/FEATURE_INVENTORY.csv.

## Required Coverage Checklist

- Feature inventory: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Business rules: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Formulas: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Edge cases: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Failure modes: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Roadmap: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
