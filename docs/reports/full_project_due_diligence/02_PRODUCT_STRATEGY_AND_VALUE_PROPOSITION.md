...
Product strategy: RAWAHEL Pulse solves foundation impact measurement by connecting strategy, execution entities, monthly KPIs, evidence stories, approval workflows, and donor/board/internal reporting. Target users are Rawahel leadership, admins, editors, viewers, entity managers, donors/board report consumers. Product-market evidence beyond repository is not found.

## Required Coverage Checklist

- Product definition: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Problem statement: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Target audience: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Personas: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Jobs-to-be-done: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Value proposition: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Differentiators: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Use cases: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Boundaries: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Missing evidence: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Strategy: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
