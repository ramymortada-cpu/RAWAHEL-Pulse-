# SITEMAP INFORMATION ARCHITECTURE AND USER FLOWS

Sitemap: authenticated dashboard/report/history/compare/items/entities/goals/pulse/admin/integrations routes; public submission token routes; report preview route. Key flows: admin creates report/entity/KPI, manager submits scoped data, admin reviews/approves, dashboard/report includes approved-only data, editor/admin exports PDF/PNG.

## Required Coverage Checklist

- Sitemap: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Public/auth/admin routes: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Submission flow: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Report flow: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Admin flow: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Navigation: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Route protection: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- UX gaps: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
