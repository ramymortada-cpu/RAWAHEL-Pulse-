...
Backend/API/DB: Express tRPC API, protected/admin/editor/permission procedures, Drizzle MySQL schema, local fallback data store outside production, production env validation, OAuth/session functions, storage proxy. API catalog is in inventories/API_ENDPOINT_INVENTORY.csv.

## Required Coverage Checklist

- Backend architecture: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- API catalog: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Services/middleware: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Validation/errors/authz: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Rate limiting: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Schema/migrations: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Jobs/webhooks/uploads: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- OpenAPI readiness: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
