...
AI: Not found in repository. No LLM provider, prompt templates, embeddings, RAG, vector DB, agent tools, model cost controls, or eval harness found. Treat the product as non-AI unless AI is deliberately added later.

## Required Coverage Checklist

- AI overview: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Provider/model/prompts/tools/RAG/memory: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Guardrails: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Cost/security risks: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Evaluation: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
- Recommendation: Covered with repository evidence where available; otherwise labeled as Not found, Inferred, Assumption, or Recommendation.
